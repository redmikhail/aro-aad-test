...
#     /subscriptions/$subscription_id/resourceGroups/$resource_group_name/providers/Microsoft.RedHatOpenShift/OpenShiftClusters/$aro_cluster_name
#
# terraform apply \
#     -var "name_prefix=$name_prefix" \
#     -var "cluster_name=$aro_cluster_name" \
...
function run_terraform() {
  ...
  if [ "$op" == "$PLAN" ]; then
   ...
   extraOptions="-auto-approve"
     ...
     extraOptions="azapi_resource.aro_cluster /subscriptions/$subscriptionId/resourceGroups/$aroResourceGroup/providers/Microsoft.RedHatOpenShift/OpenShiftClusters/$aroClusterName"
  fi
...
#    -var "name_prefix=$resourcePrefix" \
